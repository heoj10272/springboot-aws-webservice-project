...
import com.webservice.aws.springboot.config.auth.dto.OAuthAttributes;
import com.webservice.aws.springboot.config.auth.dto.SessionUser;
import com.webservice.aws.springboot.domain.user.User;
import com.webservice.aws.springboot.domain.user.UserRepository;
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // SessionUser
            ...
            // 왜 User 클래스를 쓰지 않고 새로 만들어서 쓰는지 뒤이어서 상세하게 설명하겠습니다.
                // 왜 User 클래스를 사용하면 안되나요? p.188
                // 만약 User 클래스를 그대로 사용한다면 에러가 발생합니다.
